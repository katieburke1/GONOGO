function [Hm0,T1,T02,Tp0,Te,Energy,freq] = NewSpectra(Waterlevel,SampleFreq)
%NewSpectra Calculates the spectral parameters of a timeseries of water
%elevations
%  Uses a FFT to calculate spectral energy, which is then used to detemine
%  spectral moments and calculate Wave parameters.
...
% plot(freq,Energy); hold on;plot(w,SW,'-r');
% figure()
